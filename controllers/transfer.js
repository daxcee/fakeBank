...
module.exports.acc2acc = function* acc2acc(next) {
	...
	try {
		...
		tempTran = {
			...
			"narrative": body.narrative || "Funds transfer to " + transaction.destinationAccount.name,
		...
		tempTran = {
			...
			"txnType": transaction.txnType,
			"typeName": transaction.typeName,
			"narrative": body.narrative || "Funds transfer from " + transaction.sourceAccount.name,
			"debit": 0,
